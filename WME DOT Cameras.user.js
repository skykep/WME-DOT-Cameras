...
let mapBounds;
const updateMessage = "&#9658; Updated GA feeds (includes streaming now!)";
const x2js = new X2JS();
...
(function () {
    ...
    getFeed("http://40.121.218.107/CSS", "css", "", function (result) {
        GM_addStyle(result);
    })
